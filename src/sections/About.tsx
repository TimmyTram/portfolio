        ...
        <div className="w-full flex flex-col items-center mt-4 bg-royal-blue-solid p-4 rounded-lg shadow-lg">
            ...
            <div className="w-full flex flex-col md:flex-row items-center mt-4">
                <div className="flex justify-center w-full md:w-1/3">
                    <Headshot src="/portfolio/headshot/headshot.jpg" alt="Headshot" />
                </div>
                <div className="flex flex-col justify-center items-center text-center w-full md:w-2/3 mt-4 md:mt-0 bg-black py-10">
                    ...
                    <a href="/portfolio/pdfs/Timmy-Tram-Resume.pdf" target="_blank" rel="noopener noreferrer" className="mt-4 bg-royal-gold-solid text-white px-4 py-2 rounded-xl hover:bg-royal-gold-solid-hover transition duration-300">
                        View My Resume
                    </a>
                </div>
            </div>
